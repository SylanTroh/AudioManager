...
namespace Sylan.AudioManager
{
    ...
    {
        public override string SyncScriptName => nameof(IntegerAudioZoneSync);
        ...
        /// </summary>
        [UdonSynced] private int[] syncedIds = Array.Empty<int>(); // Must have the proper "nothing" default value.
        /// <summary>
        ...
        /// </summary>
        private int[] syncedAudioZones = Array.Empty<int>(); // Must have the proper "nothing" default value.
